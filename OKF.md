...
| **Omnibus Series & DMM SKU Variants** | `OFJE-713`, `9OFJE-548`, `1SETH00008` (compilations, VR set packs, Blu-ray/DVD multi-disc prefixes) | `CheckFilmographyInclusion` filters `OFJE`, `SETH`, `OFRF`, `OFMA`, DMM numerical SKU prefixes (`4/6/7/9`), and massive minute compilations (`\d+分` $\ge 300$), moving unowned titles to `Skipped` tab. |
